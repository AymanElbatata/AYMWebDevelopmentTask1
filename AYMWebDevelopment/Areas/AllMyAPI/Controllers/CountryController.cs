    ...
    public class CountryController : ApiController
    {
        ...
        public HttpResponseMessage RetrieveAllData()
        {
            try
            {
                ...
                var data = mydb.CountryTBL.Where(A => A.IsDeleted == false).ToList();
        ...
        public HttpResponseMessage RetrieveOneById(int Id)
        {
            ...
            {
                mydb.Configuration.ProxyCreationEnabled = false;
                var data = mydb.CountryTBL.Where(A => A.IsDeleted == false && A.CountryID == Id).SingleOrDefault();
        ...
        public HttpResponseMessage RetrieveMultipleBySearch(string StartSearchWord)
        {
            ...
            {
                mydb.Configuration.ProxyCreationEnabled = false;
                var data = mydb.CountryTBL.Where(A => A.IsDeleted == false && A.CountryName.StartsWith(StartSearchWord)).ToList();
        ...
        public HttpResponseMessage RetrieveARRAYADDEDIT(int AddEDit)
        {
            ...
            {
                mydb.Configuration.ProxyCreationEnabled = false;
                var continentals = mydb.CountryTBL.Where(a => a.IsDeleted == false).Select(c => new CustomOption { DisplayText = c.CountryName, Value = c.CountryID }).ToList();
        ...
        public HttpResponseMessage RetrieveARRAYListOnly(int Listonly)
        {
            ...
            {
                mydb.Configuration.ProxyCreationEnabled = false;
                var continentals = mydb.CountryTBL.Select(c => new CustomOption { DisplayText = c.CountryName, Value = c.CountryID }).ToList();
                return Request.CreateResponse(HttpStatusCode.Accepted, continentals);
            }
            catch (Exception ex)
            {
        ...
        [HttpPost]
        public HttpResponseMessage CheckDataQueryCreate(CountryTBL myobject, int CreatePermission)
        {
            try
            {
                mydb.Configuration.ProxyCreationEnabled = false;
                int result;
                var data = mydb.CountryTBL.Where(A => A.IsDeleted == false && A.CountryName == myobject.CountryName).Count();
                if (data == 0)
                {
                    result = 0;
                }
        ...
        public HttpResponseMessage CheckDataQueryUpdate(CountryTBL myobject, int UpdatePermission)
        {
            try
            {
                mydb.Configuration.ProxyCreationEnabled = false;
                int result;
                var data = mydb.CountryTBL.Where(A => A.IsDeleted == false && A.CountryName == myobject.CountryName && A.CountryID != myobject.CountryID).Count();
                if (data == 0)
                {
                    result = 0;
                }
        ...
        [HttpPost]
        public HttpResponseMessage AddNewRow(CountryTBL myobject, int Addnew, string APISAuthPinCode, string APISAuthPassword)
        {
            try
            {
                mydb.Configuration.ProxyCreationEnabled = false;
                ...
                if (isallowed)
                {
                    ...
                    var data = mydb.CountryTBL.Add(myobject);
                    mydb.SaveChanges();
        ...
        [HttpPost]
        public HttpResponseMessage EditExistsRow(CountryTBL myobject, int EditExists, string APISAuthPinCode, string APISAuthPassword)
        {
            try
            {
                mydb.Configuration.ProxyCreationEnabled = false;

    ...
    public class BranchController : ApiController
    {
        ...
        public HttpResponseMessage RetrieveAllData()
        {
            try
            {
                ...
                var data = mydb.BranchTBL.Where(A => A.IsDeleted == false).ToList();
        ...
        public HttpResponseMessage CheckDataQueryCreate(BranchTBL myobject, int CreatePermission)
        {
            try
            {
                mydb.Configuration.ProxyCreationEnabled = false;
                int result;
                var data = mydb.BranchTBL.Where(A => A.IsDeleted == false && A.BranchName == myobject.BranchName).Count();
                if (data == 0)
                {
                    result = 0;
                }
        ...
        public HttpResponseMessage CheckDataQueryUpdate(BranchTBL myobject, int UpdatePermission)
        {
            try
            {
                mydb.Configuration.ProxyCreationEnabled = false;
                int result;
                var data = mydb.BranchTBL.Where(A => A.IsDeleted == false && A.BranchName == myobject.BranchName && A.BranchID != myobject.BranchID).Count();
                if (data == 0)
                {
                    result = 0;
                }
        ...
        [HttpPost]
        public HttpResponseMessage AddNewRow(BranchTBL myobject, int Addnew, string APISAuthPinCode, string APISAuthPassword)
        {
            try
            {
                mydb.Configuration.ProxyCreationEnabled = false;
                ...
                if (isallowed)
                {
                    ...
                    var data = mydb.BranchTBL.Add(myobject);
                    mydb.SaveChanges();
        ...
        [HttpPost]
        public HttpResponseMessage EditExistsRow(BranchTBL myobject, int EditExists, string APISAuthPinCode, string APISAuthPassword)
        {
            try
            {
                mydb.Configuration.ProxyCreationEnabled = false;
                ...
                if (isallowed)
                {
                    ...
                    mydb.SaveChanges();
                    var data = mydb.BranchTBL.Find(myobject.BranchID);
                    string json = JsonConvert.SerializeObject(data);
                    return Request.CreateResponse(HttpStatusCode.Accepted, json);
                }
                else
        ...
        [HttpPost]
        public HttpResponseMessage StopExistsRow(BranchTBL myobject, int Del, string APISAuthPinCode, string APISAuthPassword)
        {
            try
            {
                mydb.Configuration.ProxyCreationEnabled = false;
